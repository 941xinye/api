...
class WebSitePage extends LinkPager{

    public function init(){
        parent::init();
        $this->options['class'] = "pagingUl";
        $this->prevPageCssClass = "pre";
        $this->nextPageCssClass = "next";
        $this->nextPageLabel = "<i class=\"icon\"></i>";
        $this->prevPageLabel = "<i class=\"icon\"></i>";
    ...
    public function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        if ($disabled) {
            ...
            return '<li>'.Html::a($label, $this->pagination->createUrl($page), $options).'</li>';
        }
